...
class Detailmenupagestatic extends Common
{
    ...
    public function index()
    {
        ...
        foreach ($info as $v) {
            ...
            $assign_data = compact('com_name', 'title', 'keyword', 'description', 'm_url', 'redirect_code', 'menu', 'activity', 'chain_type', 'next_site', 'main_site', 'partnersite', 'pre_head_jscode', 'after_head_jscode', 'article_list', 'question_list', 'scatteredarticle_list');
