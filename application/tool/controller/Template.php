...
class Template extends CommonToken
{
    ...
    public $htmlsuffix = ['.html', '.htm', '.phtml', '.tpl'];
    ...
    public function templatelist()
    {
        ...
        if ($list) {
            switch ($list) {
                case 'static':
                    return $this->templatestaticlist();
                    break;
                case 'html':
                    return $this->templatehtmllist();
                    break;
            }
        } else {
            //如果类型不存在的话亲你跪求模板文件
     ...
     * @access public
     */
    public function templatestaticlist()
    {
        //获取文件列表
        $fileArray = [];
        if (false != ($handle = opendir($this->templatestaticpath))) {
            while (false !== ($file = readdir($handle))) {
                //去掉"“.”、“..”以及带“.xxx”后缀的文件
                if ($file != "." && $file != ".." && $file != ".env" && $file != 'README.md') {
                    $suffix = $this->getfilesuffix($file);
                    $filepath = $this->templatestaticpath . $file;
     ...
     * @access public
     */
    public function templatehtmllist()
    {
        //获取文件列表
        $fileArray = [];
