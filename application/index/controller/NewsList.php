...
class NewsList extends Common
{
    ...
    public function index($id)
    {
        ...
        $assign_data = compact('newslist', 'com_name', 'title', 'keyword', 'description', 'm_url', 'redirect_code', 'menu', 'activity', 'chain_type', 'next_site', 'main_site', 'partnersite', 'pre_head_jscode', 'after_head_jscode', 'article_list', 'question_list', 'scatteredarticle_list');
