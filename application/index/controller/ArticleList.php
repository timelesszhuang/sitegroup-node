...
class ArticleList extends Common
{
    ...
    public function index($id)
    {
        ...
        $assign_data = compact('article', 'com_name', 'title', 'keyword', 'description', 'm_url', 'redirect_code', 'menu', 'activity','before_head', 'after_head', 'chain_type', 'next_site', 'main_site', 'partnersite', 'pre_head_commonjscode', 'after_head_commonjscode','article_list', 'question_list', 'scatteredarticle_list');
